...
project = u'SpyNNakerNewModelTemplate'
...
htmlhelp_basename = 'SpyNNakerNewModelTemplate'
...
latex_documents = [
  ('index', 'SpyNNakerNewModelTemplate.tex',
   u'SpyNNakerNewModelTemplate Documentation', u'', 'manual'),
]
...
man_pages = [
    ('index', 'SpyNNakerNewModelTemplate',
     u'SpyNNakerNewModelTemplate Documentation',
     [u''], 1)
]
...
texinfo_documents = [
  ('index', 'SpyNNakerNewModelTemplate',
   u'SpyNNakerNewModelTemplate Documentation', u'',
   'SpyNNakerNewModelTemplate', '', 'Miscellaneous'),
]
...
epub_title = u'SpyNNakerNewModelTemplate'
epub_author = u''
epub_publisher = u''
...
for f in os.listdir("."):
    if (os.path.isfile(f) and f.endswith(
        ...
        os.remove(f)
apidoc.main([None, '-o', ".", "../../python_models"])
