...
class ONeuron(AbstractPopulationVertex):
    ...
    def __init__(
        ...
        AbstractPopulationVertex.__init__(
            ...
            max_atoms_per_core=ONeuron._model_based_max_atoms_per_core,
    ...
    def get_max_atoms_per_core():
        ...
        # TODO: Ensure the correct class is used below
        return ONeuron._model_based_max_atoms_per_core

    @staticmethod
    def set_max_atoms_per_core(new_value):

        # TODO: Ensure the correct class is used below
        ONeuron._model_based_max_atoms_per_core = new_value
